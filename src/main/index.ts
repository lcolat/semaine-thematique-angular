...
const simulation = (): Promise<Pokemon> => {
    let pikachu: Pokemon = new Pokemon("Pikachu", 1, 90, 35, 55, 40, Array<Attack>(new Attack("eclair", 40, "special", "electric", 100)));
    let bulbasaur: Pokemon = new Pokemon("Bulbasaur",1,45,45,49,49,Array<Attack>(new Attack("charge", 40, "physical", "normal", 100)));
    ...
    return new Promise((resolve, reject) => {
        ...
        }, 500 ,pikachu, bulbasaur);
    })
};

simulation().then(res => console.log(`\n#### ${res.name} win the fight ####`)).catch(e => console.log(e));